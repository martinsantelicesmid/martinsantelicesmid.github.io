...
function init() {
    ...
    let markerControl = new THREEx.ArMarkerControls(arToolkitContext, markerRoot1, {
        ...
        type: 'pattern', patternUrl: 'data/pattern-figura.patt',
    });
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('base1.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('base1.obj', function (group) {
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('base2.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('base2.obj', function (group) {
    ...
    new THREE.MTLLoader()
    .setPath('data/models/')
    .load('base3.mtl', function (materials) {
        materials.preload();
        new THREE.OBJLoader()
            .setMaterials(materials)
            .setPath('data/models/')
            .load('base3.obj', function (group) {
       ...
       new THREE.MTLLoader()
       .setPath('data/models/')
       .load('base4.mtl', function (materials) {
           materials.preload();
           new THREE.OBJLoader()
               .setMaterials(materials)
               .setPath('data/models/')
               .load('base4.obj', function (group) {
    ...
    new THREE.MTLLoader()
    .setPath('data/models/')
    .load('base5.mtl', function (materials) {
        materials.preload();
        new THREE.OBJLoader()
            .setMaterials(materials)
            .setPath('data/models/')
            .load('base5.obj', function (group) {
